        ...
        <div>
            ...
            <div className='justify-items-center mt-10 grid sm:grid-cols-1 md:grid-cols-3'>
                ...
                <div className='rounded-lg shadow-lg bg-gray-100 max-w-sm p-5 h-h-[550px] w-[350px] hover:bg-blue-50 mx-2 mb-5'>
                    ...
                    <p className='text-center text-[16px]' >There are several competitors and alternatives to firebase realtime database. Some of them are: Oracle Database, DataStax Enterprise, Redis Enterprise Cloud, Cloudera Enterprise Data Hub, Db2, MarkLogic, Couchbase Server, Neo4j.</p>
                </div>
                <div className='rounded-lg shadow-lg bg-gray-100 max-w-sm p-5 h-h-[550px] w-[350px] hover:bg-blue-50 mx-2 mb-5'>
                    <h1 className='text-center font-bold text-[20px] p-3 mt-[10]'>Difference between authorization and authentication?</h1>
                    <p className='text-center text-[16px]'>Authentication verifies who the user is.Authentication works through passwords, one-time pins, biometric information, and other information provided or entered by the user.Authentication is the first step of a good identity and access management process.</p>
                    <p className='text-center text-[16px]'>Authorization determines what resources a user can access.Authorization works through settings that are implemented and maintained by the organization.Authorization always takes place after authentication.Authorization isn’t visible to or changeable by the user.</p>
                </div>
            </div>
        </div>
    );
